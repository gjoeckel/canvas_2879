...
def main():
    ...
    html_lines.extend([
        ...
        '                    ',
                    ...
                    '                    // For local development: http://localhost:5000/update-canvas-api',
                    '                    // For production: Deploy update-canvas-api.py as serverless function',
                    '                    const isLocal = window.location.hostname === "localhost" || ',
                    '                                   window.location.hostname === "127.0.0.1" || ',
                    '                                   window.location.hostname === "";',
                    '                    const apiUrl = isLocal',
                    '                        ? "http://localhost:5000/update-canvas-api"',
                    '                        : null; // API endpoint not configured for production',
                    '                    ',
                    '                    if (!apiUrl) {',
                    '                        // Show error message',
                    ...
                    '                        errorDiv.innerHTML = `<strong>Error:</strong> API endpoint not configured. Please run <code>python3 update-canvas-api.py</code> locally or deploy as serverless function.`;',
